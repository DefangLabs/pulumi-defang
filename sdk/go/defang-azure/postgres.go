...
import (
	...
	"errors"
	"github.com/DefangLabs/pulumi-defang/sdk/go/defang-azure/compose"
...
func NewPostgres(ctx *pulumi.Context,
	...
	err := ctx.RegisterRemoteComponentResource("defang-azure:index:Postgres", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
