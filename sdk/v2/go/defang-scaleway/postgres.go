...
func NewPostgres(ctx *pulumi.Context,
	...
	err := ctx.RegisterRemoteComponentResource("defang-scaleway:index:Postgres", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o PostgresOutput) ConnectionUrl() pulumi.StringOutput {
	return o.ApplyT(func(v *Postgres) pulumi.StringOutput { return v.ConnectionUrl }).(pulumi.StringOutput)
}
