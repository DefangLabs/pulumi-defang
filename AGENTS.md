...
- **`add_knowledge`** — Store observations about:
  ...
  - Code conventions not captured in AGENTS.md (entityType: `style`)
...
Do NOT store: code patterns derivable from the codebase, git history, ephemeral task details, or anything already in AGENTS.md.
