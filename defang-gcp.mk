...
go_sdk: provider
	...
	@if [ -d "sdk/go/defanggcp" ] && [ ! -d "sdk/go/${PACK}" ]; then mv "sdk/go/defanggcp" "sdk/go/${PACK}"; fi
...
nodejs_sdk: provider
	...
	@if [ -d "sdk/nodejs/defanggcp" ]; then mv sdk/nodejs/defanggcp/* sdk/nodejs/${PACK}/ && rmdir sdk/nodejs/defanggcp; fi
...
python_sdk: provider
	...
	@if [ -d "sdk/python/defanggcp" ]; then mv sdk/python/defanggcp/* sdk/python/${PACK}/ && rmdir sdk/python/defanggcp; fi
...
dotnet_sdk: provider
	...
	@if [ -d "sdk/dotnet/defanggcp" ]; then mv sdk/dotnet/defanggcp/* sdk/dotnet/${PACK}/ && rmdir sdk/dotnet/defanggcp; fi
