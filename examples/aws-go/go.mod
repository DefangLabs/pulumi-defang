...
// main.go imports the nested defang-aws SDK module (sdk/v2/go/defang-aws),
// not the legacy aggregate sdk/v2. Point at the in-tree source so this
// example builds against the workspace, matching multi-cloud and
